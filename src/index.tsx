...
import { Main as MotorcycleConflictReel } from './compositions/Main';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* Motorcycle Conflict Reel - 13s 9:16 Instagram Reel */}
      <Composition
        id="MotorcycleConflictReel"
        component={MotorcycleConflictReel}
